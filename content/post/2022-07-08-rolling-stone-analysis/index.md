...
For those who don't want to read the article, I built an accompanying Streamlit application for further exploration of the Rolling Stone top 500 data. Try it out [here](https://rolling-stonalytics.streamlit.app/). You can also download the dataset [here](data/spotify_music_output.csv) for your own use.
...
Of course, this wouldn't be complete if I did not allow you as a reader to play around with this data yourself. As with many other projects I've undertaken, I built an accompanying Streamlit application for further exploration on UMAP and DBSCAN. Try it out [here](https://rolling-stonalytics.streamlit.app/). You can also download the dataset [here](data/spotify_music_output.csv) for your own use.
